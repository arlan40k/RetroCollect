    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if(local){
                    Intent localMerchantIntent = new Intent(getActivity(), LocalMerchantActivity.class);
                    ...
                    String url = "https://www.amazon.com/s/ref=nb_sb_noss?url=search-alias%3Dvideogames&field-keywords="+ search
